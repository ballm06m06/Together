...
public class Female_AddInfo extends javax.swing.JFrame {

    /**
     * Creates new form Female_AddInfo
     */
    public Female_AddInfo() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jPanel2.setBackground(new java.awt.Color(216, 27, 96));

        jPanel3.setBackground(new java.awt.Color(236, 64, 122));

        jLabel3.setIcon(new javax.swing.ImageIcon("C:\\Users\\user\\java\\imgs\\girl.png")); // NOI18N

        jLabel1.setFont(new java.awt.Font("Comic Sans MS", 0, 30)); // NOI18N
        jLabel1.setForeground(new java.awt.Color(255, 255, 255));
        jLabel1.setText("Female Info");
        ...
        jButton1.setIcon(new javax.swing.ImageIcon("C:\\Users\\user\\java\\imgs\\confirm_button_blue.png")); // NOI18N
        ...
        jComboBox2.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Rose", "Tulip", "Sunflower", "Iris", "Chrysanthemum" }));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Female_AddInfo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Female_AddInfo().setVisible(true);
            }
        });
    }
		...
		public void actionPerformed(ActionEvent e){
			...
			while(flag == false){
				...
				if(isNumeric(jTextField2.getText())){
					System.out.println("height接收值為float type");
					flag = true;
				}
				else{
			...
			while(flag1 == false){
				...
				if(isNumeric(jTextField3.getText())){
					System.out.println("weight接收值為float type");
					flag1 = true;
				}
				else{
			...
			while(flag2 == false){
				...
				if(isNumeric(jTextField4.getText())){
					System.out.println("age接收值為float type");
					flag2 = true;
				}
				else{
			...
			//open the file ,then write the new data
			if(flag == true && flag1 == true && flag2 == true && jCheckBox1.isSelected() == true)
			{
				...
				p.println(" "+jTextField1.getText()+" "+jTextField2.getText()+" "+jTextField3.getText()+" "+jTextField4.getText()+" "+jComboBox1.getSelectedItem().toString()+
						" "+jComboBox2.getSelectedItem().toString());
		
				
				
				Female_Member female = new Female_Member("","",jTextField1.getText(),Float.parseFloat(jTextField2.getText()),Float.parseFloat(jTextField3.getText()),
